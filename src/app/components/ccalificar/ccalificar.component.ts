...
public lista_respuestas: any[]=[];
  ...
  select_subgiro(){
    this.sniper=true;
    let giro=this.model_calificar['Giro'];
  ...
  select_rama(){
    this.sniper=true;
    let subgiro=this.model_calificar['Subgiro'];
  ...
  obtener_cuestionario(){
    ...
    if(this.model_calificar["Razon"]===undefined){
      ...
      const datosEmisor={Correo:this.datosusuarios["Correo"],IDUsuario:this.datosusuarios["IDUsuario"],IDEmpresa:this.datosempresa["IDEmpresa"]}
